...
export default function Home() {
  return (
    <main className="bg-white">
      ...
      <section className="border-t border-zinc-200 bg-zinc-50 px-4 py-20 sm:px-6 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="space-y-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-orange-100 text-2xl font-bold text-orange-600 mx-auto">
                1
              </div>
